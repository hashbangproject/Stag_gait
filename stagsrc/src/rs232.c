...
int OpenComport(int comport_number, int baudrate, float cbr)
{
  int baudr;
  ...
  new_port_settings.c_cflag = B38400 | CS8 | CLOCAL | CREAD;
  ...
  tcflush(Cport[comport_number], TCIFLUSH);//NOT SURE
  ...
  if(error==-1)
  {
    ...
    serinfo.custom_divisor = serinfo.baud_base / cbr;
    ...
    //gfByteTransTime = (float) ((1000.0f / cbr) * 12.0f);
